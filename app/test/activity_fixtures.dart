...
Operation op(
  String id,
  OpKind kind, {
  List<String> vaults = const ['life', 'health'],
  bool undone = false,
  String? note,
}) => Operation(
  opId: id,
  kind: kind,
  summary:
      'Filed your voice note to Life and Health: updated Journal · 23 Sep, Sara; 1 claim',
...
FakeLibrary activityLibrary() {
  ...
  lib.ops.addAll([
    op('01OPB', OpKind.ingest),
    op('01OPA', OpKind.ingest, vaults: const ['work'], undone: true),
  ]);
    ...
    PageDiff(
      ...
      lines: [
        ...
        DiffLine(
          ...
          text: '- Lives in Shiraz since September',
        ),
      ],
    ),
  ];
  lib.cards.addAll(const [
    ReviewCardDto(
      ...
      claim: ClaimInfo(
        id: 'c-1',
        text: 'Headaches follow short nights',
        status: 'proposed',
        confidence: 'low',
        sources: [],
      ),
